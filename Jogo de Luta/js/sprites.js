...
class Sprite {
    ...
    loadSprite() {
        ...
        this.framePerSpriteFrame = this.currentSprite.framePerSpriteFrame
    ...
    animate() {
        ...
        if (this.elapsedTime >= this.framePerSpriteFrame) {
